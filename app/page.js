...
export default function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-88px)] bg-white flex flex-col justify-center items-center">
      <h1 className="text-4xl text-center font-bold mb-4">Metro Booking System</h1>
      <p className="text-lg text-center text-gray-600 mb-8">Book your metro tickets easily and quickly online.</p>
